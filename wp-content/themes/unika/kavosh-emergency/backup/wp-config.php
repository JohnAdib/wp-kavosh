...
define('DB_NAME', 'kavosh');

/** MySQL database username */
define('DB_USER', 'kavosh');

/** MySQL database password */
define('DB_PASSWORD', 'Q1oesVo6Nn');

/** MySQL hostname */
define('DB_HOST', 'd.db.behgar.com:33333');
...
//define( 'WP_CONTENT_URL', 'http://static.kavosh.ac.ir');
